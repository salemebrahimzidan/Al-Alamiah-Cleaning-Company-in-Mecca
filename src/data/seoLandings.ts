...
const pages: Record<SeoSlug, { ar: SeoPageContent; en: SeoPageContent }> = {
  "home-cleaning-makkah": {
    ar: {
      ...
      title:
        "تنظيف منازل مكة | تنظيف شقق مكة | شركة تنظيف سكني | شركة العالمية للتنظيف",
      description:
    ...
    en: {
      path: "/services/home-cleaning-makkah",
      title:
        "House Cleaning in Mecca | Apartments & Homes | Al-Alamiya Cleaning",
      description:
  ...
  "ac-cleaning-makkah": {
    ar: {
      ...
      title:
        "تنظيف مكيفات مكة | غسيل وصيانة مكيفات سبليت وشباك | شركة العالمية للتنظيف",
      description:
    ...
    en: {
      path: "/services/ac-cleaning-makkah",
      title:
        "AC Cleaning in Mecca | Split & Window Units | Al-Alamiya Cleaning",
      description:
  ...
  "sofa-carpet-cleaning-makkah": {
    ar: {
      ...
      title:
        "تنظيف كنب وسجاد مكة | تنميع وغسيل بالبخار | شركة العالمية للتنظيف",
      description:
    ...
    en: {
      path: "/services/sofa-carpet-cleaning-makkah",
      title:
        "Sofa & Carpet Cleaning in Mecca | Steam & Shampoo | Al-Alamiya Cleaning",
      description:
  ...
  "apartment-cleaning-makkah": {
    ar: {
      path: "/services/apartment-cleaning-makkah",
      title: "تنظيف شقق مكة | شركة تنظيف شقق | شركة العالمية للتنظيف",
      description:
        "تنظيف شقق في مكة المكرمة بزيارات منظمة ومواد آمنة. مطابخ وحمامات وغرف. احجز عبر واتساب.",
      h1: "تنظيف شقق في مكة المكرمة",
      blocks: [
        {
          type: "p",
          text: "الشقق تحتاج تنظيماً ذكياً للمساحات الأصغر مع الحفاظ على الجودة. نركّز على المطابخ والحمامات والأرضيات والغبار، مع إمكانية إضافة نوافذ داخلية أو مفروشات حسب الاتفاق.",
        },
        {
          type: "h2",
          text: "لماذا صفحة مخصصة لتنظيف الشقق؟",
        },
        {
          type: "p",
          text: "لأن زمن الزيارة والمسار يختلف عن الفلل والبيوت الكبيرة. نحدد معك عدد الغرف والمطبخ والحمامات لعرض عادل وسريع.",
        },
        {
          type: "h2",
          text: "مناطق نخدمها في مكة",
        },
        {
          type: "p",
          text: "نعمل في أحياء مكة بما في ذلك العزيزية والشوقية والمناطق القريبة من الحركة حول الحرم حسب التنسيق والوصول.",
        },
        {
          type: "h2",
          text: "احجز عبر واتساب",
        },
        {
          type: "p",
          text: "أرسل «شقة» مع الحي وعدد الغرف والتاريخ المناسب.",
        },
      ],
      relatedSlugs: [
        "home-cleaning-makkah",
    ...
    en: {
      path: "/services/apartment-cleaning-makkah",
      title:
        "Apartment Cleaning in Mecca | Flats & Units | Al-Alamiya Cleaning",
      description:
        "Apartment cleaning in Makkah: kitchens, bathrooms, floors, and dusting—clear scope and fast replies on WhatsApp.",
      h1: "Apartment Cleaning in Mecca (Makkah)",
      blocks: [
        {
          type: "p",
          text: "Apartments need efficient workflows in compact spaces. We prioritize kitchens, bathrooms, floors, and dusting, with add-ons like interior glass or upholstery by agreement.",
        },
        {
          type: "h2",
          text: "Why a dedicated apartment page",
        },
        {
          type: "p",
          text: "Visit duration and access patterns differ from villas. Share room count and layout for a fair quote.",
        },
        {
          type: "h2",
          text: "Districts we serve",
        },
        {
          type: "p",
          text: "Across Makkah including Al Aziziyah, Al Shawqiyah, and near Al Haram by arrangement.",
        },
        {
          type: "h2",
        ...
        {
          type: "p",
          text: "Message “apartment”, your district, room count, and preferred date.",
        },
      ],
      relatedSlugs: [
        "home-cleaning-makkah",
  ...
  "pest-control-makkah": {
    ar: {
      path: "/services/pest-control-makkah",
      title: "مكافحة حشرات مكة | رش ووقاية | شركة العالمية للتنظيف",
      description:
        "مكافحة حشرات في مكة المكرمة مع تقييم أولي وتنسيق آمن للسكان. تواصل واتساب لتحديد نوع الإصابة والموعد.",
      h1: "مكافحة حشرات في مكة المكرمة",
      blocks: [
        {
          type: "p",
          text: "نوفر خدمات مكافحة حشرات ضمن تنسيق واضح: تقييم أولي، اختيار طريقة مناسبة، ومواعيد تحترم وجود العائلة حيثما أمكن.",
        },
        {
          type: "h2",
          text: "ما الذي نناقشه قبل الزيارة؟",
        },
        {
          type: "p",
          text: "نوع المشكلة، مساحة تقريبية، وجود أطفال أو حيوانات أليفة، وأي حساسية من مواد معينة—لنختار خطة أكثر أماناً.",
        },
        {
          type: "h2",
          text: "التنسيق مع التنظيف المنزلي",
        },
        {
          type: "p",
          text: "يمكن جدولة مكافحة الحشرات بشكل منفصل أو بالتنسيق مع زيارة تنظيف منزل أو شقة حسب الحاجة.",
        },
        {
          type: "h2",
        ...
        {
          type: "p",
          text: "صف المشكلة باختصار والحي في مكة لنقترح الخطوة التالية.",
        },
      ],
      relatedSlugs: [
        "home-cleaning-makkah",
    ...
    en: {
      path: "/services/pest-control-makkah",
      title:
        "Pest Control in Mecca | Spraying & Prevention | Al-Alamiya Cleaning",
      description:
        "Pest control in Makkah with clear assessment and safer scheduling. WhatsApp us with the issue type and district.",
      h1: "Pest Control in Mecca (Makkah)",
      blocks: [
        {
          type: "p",
          text: "We coordinate pest control with realistic expectations: initial assessment, method selection, and timing that respects residents and pets where possible.",
        },
        {
          type: "h2",
          text: "What we confirm before the visit",
        },
        {
          type: "p",
          text: "Pest type, approximate area, sensitivities, and access—so we can propose a sensible plan.",
        },
        {
          type: "h2",
          text: "Works alongside home cleaning",
        },
        {
          type: "p",
          text: "Pest control can be scheduled separately or coordinated with home or apartment cleaning when needed.",
        },
        {
          type: "h2",
        ...
        {
          type: "p",
          text: "Briefly describe the issue and your district in Makkah.",
        },
      ],
      relatedSlugs: [
        "home-cleaning-makkah",
  ...
  "al-aziziyah-makkah": {
    ar: {
      ...
      title:
        "تنظيف العزيزية مكة | شركة تنظيف بالعزيزية | شركة العالمية للتنظيف",
      description:
  ...
  "near-al-haram-makkah": {
    ar: {
      ...
      title:
        "تنظيف قرب الحرم مكة | تنظيف شقق قرب الحرم | شركة العالمية للتنظيف",
      description:
...
export const ALL_SEO_SLUGS: SeoSlug[] = [
  ...SEO_SERVICE_SLUGS,
  ...SEO_LOCATION_SLUGS,
];

export type ServiceSeoSlug = (typeof SEO_SERVICE_SLUGS)[number];

/** Canonical public path segment after domain (no leading slash), e.g. `services/house-cleaning`. */
export const PUBLIC_SERVICE_PATH: Record<ServiceSeoSlug, string> = {
  "home-cleaning-makkah": "services/house-cleaning",
  "apartment-cleaning-makkah": "services/apartment-cleaning",
  "villa-cleaning-makkah": "services/villa-cleaning",
  "office-cleaning-makkah": "services/office-cleaning",
  "deep-cleaning-makkah": "services/deep-cleaning",
  "ac-cleaning-makkah": "services/ac-cleaning",
  "sofa-carpet-cleaning-makkah": "services/sofa-carpet",
  "pest-control-makkah": "services/pest-control",
};

export function publicPathForServiceSlug(slug: ServiceSeoSlug): string {
  return `/${PUBLIC_SERVICE_PATH[slug]}`;
}

/** Resolve `/services/:param` URL segment to internal service SEO slug (supports legacy `*-makkah` slugs). */
export function resolveServiceParamToSlug(
  param: string | undefined,
): ServiceSeoSlug | null {
  if (!param) return null;

  for (const slug of SEO_SERVICE_SLUGS) {
    const publicPath = PUBLIC_SERVICE_PATH[slug];
    if (publicPath.replace(/^services\//, "") === param) return slug;
  }

  if ((SEO_SERVICE_SLUGS as readonly string[]).includes(param)) {
    return param as ServiceSeoSlug;
  }
...
export function getSeoSlugFromPath(pathname: string): SeoSlug | null {
  ...
  const m = normalized.match(/^\/services\/([^/]+)$/);
  if (m) {
    const svc = resolveServiceParamToSlug(m[1]);
    if (svc) return svc;
  }
  return null;
}
